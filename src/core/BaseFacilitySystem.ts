...
export const FACILITY_DEFINITIONS: FacilityDefinition[] = [
  ...
  },
  {
    ...
    name: '芯片研发',
    icon: '💾',
    description: '解锁芯片品质和槽位',
    color: '#10b981',
    maxLevel: 5,
    levels: [
      { level: 1, upgradeCost: { credits: 0, materials: [] }, effects: { description: '可制作品质', value: 1 } },
      { level: 2, upgradeCost: { credits: 3000, materials: [{ itemId: 'mineral_copper', count: 10 }, { itemId: 'research_star', count: 1 }] }, effects: { description: '可制作品质', value: 2 } },
      { level: 3, upgradeCost: { credits: 6000, materials: [{ itemId: 'mineral_titanium', count: 8 }, { itemId: 'research_star', count: 1 }] }, effects: { description: '可制作品质', value: 3 } },
      { level: 4, upgradeCost: { credits: 12000, materials: [{ itemId: 'mineral_crystal', count: 6 }, { itemId: 'research_star', count: 1 }] }, effects: { description: '可制作品质', value: 3 } },
      { level: 5, upgradeCost: { credits: 25000, materials: [{ itemId: 'mineral_quantum', count: 4 }, { itemId: 'research_star', count: 1 }] }, effects: { description: '可制作品质', value: 3 } },
    ],
  },
  {
  ...
  },
  {
    ...
    name: '机械飞升',
    icon: '🦾',
    description: '解锁义体品质和槽位',
    color: '#f97316',
    maxLevel: 5,
    levels: [
      { level: 1, upgradeCost: { credits: 0, materials: [] }, effects: { description: '可制作品质', value: 1 } },
      { level: 2, upgradeCost: { credits: 5000, materials: [{ itemId: 'cyber_material', count: 10 }, { itemId: 'research_star', count: 1 }] }, effects: { description: '可制作品质', value: 2 } },
      { level: 3, upgradeCost: { credits: 10000, materials: [{ itemId: 'cyber_material', count: 20 }, { itemId: 'research_star', count: 1 }] }, effects: { description: '可制作品质', value: 3 } },
      { level: 4, upgradeCost: { credits: 20000, materials: [{ itemId: 'cyber_core', count: 3 }, { itemId: 'research_star', count: 1 }] }, effects: { description: '可制作品质', value: 3 } },
      { level: 5, upgradeCost: { credits: 40000, materials: [{ itemId: 'cyber_core', count: 5 }, { itemId: 'research_star', count: 1 }] }, effects: { description: '可制作品质', value: 3 } },
    ],
  },
  {
