...
export const FACILITY_DEFINITIONS: FacilityDefinition[] = [
  {
    ...
    levels: [
      ...
      { level: 2, upgradeCost: { credits: 1000, materials: [{ itemId: 'mat_001_stardust', count: 10 }] }, effects: { description: '自动采集效率', value: 10 } },
      { level: 3, upgradeCost: { credits: 2000, materials: [{ itemId: 'mat_001_stardust', count: 20 }] }, effects: { description: '自动采集效率', value: 20 } },
      { level: 4, upgradeCost: { credits: 4000, materials: [{ itemId: 'mat_001_alloy', count: 15 }] }, effects: { description: '自动采集效率', value: 30 } },
      { level: 5, upgradeCost: { credits: 8000, materials: [{ itemId: 'mat_001_alloy', count: 25 }] }, effects: { description: '自动采集效率', value: 40 } },
      { level: 6, upgradeCost: { credits: 15000, materials: [{ itemId: 'mat_001_crystal', count: 20 }] }, effects: { description: '自动采集效率', value: 50 } },
      { level: 7, upgradeCost: { credits: 30000, materials: [{ itemId: 'mat_001_crystal', count: 30 }] }, effects: { description: '自动采集效率', value: 60 } },
      { level: 8, upgradeCost: { credits: 60000, materials: [{ itemId: 'mat_001_quantum', count: 20 }] }, effects: { description: '自动采集效率', value: 70 } },
      { level: 9, upgradeCost: { credits: 100000, materials: [{ itemId: 'mat_001_quantum', count: 30 }] }, effects: { description: '自动采集效率', value: 80 } },
      { level: 10, upgradeCost: { credits: 200000, materials: [{ itemId: 'mat_001_void', count: 25 }] }, effects: { description: '自动采集效率', value: 100 } },
    ],
  },
  {
    ...
    levels: [
      ...
      { level: 2, upgradeCost: { credits: 500, materials: [] }, effects: { description: '存储容量', value: 120 } },
      { level: 3, upgradeCost: { credits: 1000, materials: [] }, effects: { description: '存储容量', value: 150 } },
      { level: 4, upgradeCost: { credits: 2000, materials: [] }, effects: { description: '存储容量', value: 180 } },
      { level: 5, upgradeCost: { credits: 4000, materials: [] }, effects: { description: '存储容量', value: 220 } },
      { level: 6, upgradeCost: { credits: 8000, materials: [] }, effects: { description: '存储容量', value: 270 } },
      { level: 7, upgradeCost: { credits: 15000, materials: [] }, effects: { description: '存储容量', value: 330 } },
      { level: 8, upgradeCost: { credits: 30000, materials: [] }, effects: { description: '存储容量', value: 400 } },
      { level: 9, upgradeCost: { credits: 60000, materials: [] }, effects: { description: '存储容量', value: 480 } },
      { level: 10, upgradeCost: { credits: 100000, materials: [] }, effects: { description: '存储容量', value: 600 } },
    ],
  },
  {
    ...
    levels: [
      ...
      { level: 2, upgradeCost: { credits: 2000, materials: [{ itemId: 'mat_006_stardust', count: 5 }] }, effects: { description: '恢复效率', value: 100 } },
      { level: 3, upgradeCost: { credits: 5000, materials: [{ itemId: 'mat_006_alloy', count: 8 }] }, effects: { description: '恢复效率', value: 200 } },
      { level: 4, upgradeCost: { credits: 10000, materials: [{ itemId: 'mat_006_crystal', count: 10 }] }, effects: { description: '恢复效率', value: 300 } },
      { level: 5, upgradeCost: { credits: 20000, materials: [{ itemId: 'mat_006_quantum', count: 12 }] }, effects: { description: '恢复效率', value: 400 } },
    ],
  },
  {
  ...
  },
  {
    ...
    name: '通讯阵列',
    icon: '📡',
    description: '扫描并响应星际通讯信号',
    color: '#8b5cf6',
    maxLevel: 5,
    levels: [
      { level: 1, upgradeCost: { credits: 0, materials: [] }, effects: { description: '信号容量', value: 3 } },
      { level: 2, upgradeCost: { credits: 2000, materials: [{ itemId: 'mat_003_stardust', count: 5 }] }, effects: { description: '信号容量', value: 4 } },
      { level: 3, upgradeCost: { credits: 5000, materials: [{ itemId: 'mat_003_alloy', count: 8 }] }, effects: { description: '信号容量', value: 5 } },
      { level: 4, upgradeCost: { credits: 10000, materials: [{ itemId: 'mat_003_crystal', count: 10 }] }, effects: { description: '信号容量', value: 6 } },
      { level: 5, upgradeCost: { credits: 20000, materials: [{ itemId: 'mat_003_quantum', count: 12 }] }, effects: { description: '信号容量', value: 8 } },
    ],
  },
  {
  ...
  },
  {
    ...
    levels: [
      ...
      { level: 2, upgradeCost: { credits: 2500, materials: [{ itemId: 'mat_005_stardust', count: 5 }] }, effects: { description: '采矿效率', value: 10 } },
      { level: 3, upgradeCost: { credits: 5000, materials: [{ itemId: 'mat_005_alloy', count: 8 }] }, effects: { description: '采矿效率', value: 20 } },
      { level: 4, upgradeCost: { credits: 10000, materials: [{ itemId: 'mat_005_crystal', count: 10 }] }, effects: { description: '采矿效率', value: 30 } },
      { level: 5, upgradeCost: { credits: 20000, materials: [{ itemId: 'mat_005_quantum', count: 12 }] }, effects: { description: '采矿效率', value: 40 } },
    ],
  },
  {
    ...
    levels: [
      ...
      { level: 2, upgradeCost: { credits: 3000, materials: [{ itemId: 'mineral_copper', count: 10 }] }, effects: { description: '芯片槽位', value: 2 } },
      { level: 3, upgradeCost: { credits: 6000, materials: [{ itemId: 'mineral_titanium', count: 8 }] }, effects: { description: '芯片槽位', value: 3 } },
      { level: 4, upgradeCost: { credits: 12000, materials: [{ itemId: 'mineral_crystal', count: 6 }] }, effects: { description: '芯片槽位', value: 3 } },
      { level: 5, upgradeCost: { credits: 25000, materials: [{ itemId: 'mineral_quantum', count: 4 }] }, effects: { description: '芯片槽位', value: 4 } },
    ],
  },
  {
    ...
    levels: [
      ...
      { level: 2, upgradeCost: { credits: 4000, materials: [{ itemId: 'gene_material', count: 5 }] }, effects: { description: '基因解锁', value: 5 } },
